...
public class Item {
	 ...
	 */
	//Item is private ²»ÄÜ¼Ì³Ð£¨cannot expand)
	...
	//JSONObject for front end. convert item to JSON object
	...
	public static class ItemBuilder {
		...
		public ItemBuilder setItemId(String itemId) {
			//this == itemBuilder object inside this method
			this.itemId = itemId;
			return this;
		}
		...
		//define build function to create a ItemBuilder object from Item object
		//itemBuilder.Build() --> item instance
		public Item build() {
