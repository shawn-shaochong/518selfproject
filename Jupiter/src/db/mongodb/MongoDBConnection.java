...
public class MongoDBConnection implements DBConnection {
	...
	//saveItem funciton for mongodb, check if the gramma is correct.... MongoDB is different.....
	//Please check later!!!!!!!    //seems correct 05/09
	@Override
	...
	public boolean verifyLogin(String userId, String password) {
		...
		if (iterable.first() != null) {
			...
			//use always true for testing
			//return true;
		}
		//use true for testing
		//return true;
		return false;
	}
